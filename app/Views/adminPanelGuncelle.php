...
<body>
	...
	<div class="row kluCenter">
		...
		<div class="col-8 pt-3">
			<div class="adminButton"><a href="<?php echo $SiteLinki . "public/adminController" ?>">Yöneticiler Listesi</a></div>
			<form action="<?php echo $SiteLinki . "public/adminController/adminPanelGuncelle/" . $yoneticiBilgileri->id;?>" method="post">
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<select class="form-control" name="yonetimFaktoru" id="yonetimFaktoru"> 
						...
						?>
						<option value="0" <?php echo $yoneticiBilgileri=0?"selected":"";?>>Yönetici</option> 
						<option value="1" <?php echo $yoneticiBilgileri=1?"selected":"";?>>Üst Düzey Yönetici</option>
					</select>
				</div>
